        ...
        <div class="container">
            <div class="top-hader-main-box white-text">
                ...
                <ul class="header-social">
                    <li>
                        <a href="/cdn-cgi/l/email-protection#a4cdcac2cbe4cdcac0d1d6cdd78ac7cbc9"
                           title="Mail on info@induris.com">
                            <img src="{{asset('vendor/landing2')}}/assets/images/mail-icon.svg" width="18" height="13"
                                 alt="Mail Icon">
                            <span><span class="__cf_email__" data-cfemail="234a4d454c634a4d4756514a500d404c4e">[email&#160;protected]</span></span>
                        </a>
                    </li>
                    <li>
                ...
                <div class="col-lg-2">
                    <div class="site-branding">
                        <a href="{{ route('home.index') }}" title="PT Sadikun BBM">
                            <img src="{{asset('vendor/landing2')}}/assets/images/logo.svg" width="152" height="35"
                                 alt="Induris Logo">
                        </a>
                    </div>
                </div>
                        ...
                        <nav class="main-navigation">
                            ...
                            <div class="header-mobile-menu">
                                <ul class="main-menu">
                                    ...
                                    <li>
                                        <a href="{{ route('home.products') }}" title="Products">Career</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('home.products') }}" title="Products">Blog</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('home.products') }}" title="Products">Social</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('home.products') }}" title="Products">Contact Us</a>
                                    </li>
                                </ul>
