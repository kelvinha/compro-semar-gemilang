...
<!-- Simplebar JS Link -->
<script src="{{asset('vendor/landing2')}}/assets/js/simplebar.js"></script>
<!-- Font Awesome JS Link -->
<script src="{{asset('vendor/landing2')}}/assets/js/font-awesome.min.js"></script>
<!-- Swiper Slider JS Link -->
<script src="{{asset('vendor/landing2')}}/assets/js/swiper-bundle.min.js"></script>
<!-- Magnific Popup JS Link -->
<script src="{{asset('vendor/landing2')}}/assets/js/jquery.magnific-popup.min.js"></script>
