    ...
    <section class="about-us-area pt-100 pb-70">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-img">
                        <img src="{{ asset('vendor/landing/assets/img/about-img.jpg') }}"
                             alt="PT Industri Teknologi Torsi">
                    </div>
                </div>
                    ...
                    <div class="about-content">
                        ...
                        <div class="tab">
                            ...
                            <div class="tab_content">
                                <div class="tabs_item">
                                    <p>PT Industri Teknologi Torsi adalah produsen khusus komponen otomasi dan katup
                                        yang
                                ...
                                <div class="tabs_item">
                                    <p>Menjadi penyedia solusi otomasi katup terkemuka di Indonesia, dengan produk
                                        berkualitas tinggi yang diproduksi secara lokal dan mematuhi peraturan
                                        industri.</p>
                                </div>
            ...
            <div class="testimonials">
                ...
                <div class="testimonials-slider owl-carousel owl-theme">
                    ...
                    @else
                        ...
                        <div class="testimonials-item">
                            <i class="flaticon-quote"></i>
                            <p>"PT Industri Teknologi Torsi telah menjadi mitra kami selama bertahun-tahun, dan mereka
                                selalu
                                memberikan hasil yang luar biasa. Tim mereka profesional, responsif, dan benar-benar
                                peduli
                        ...
                        <div class="testimonials-item">
                            <i class="flaticon-quote"></i>
                            <p>"Pendekatan inovatif mereka dalam memecahkan masalah telah membantu kami mengatasi
                                berbagai
                                tantangan. Kami sangat merekomendasikan layanan mereka kepada siapa pun yang mencari
                                mitra yang
                                andal."</p>
