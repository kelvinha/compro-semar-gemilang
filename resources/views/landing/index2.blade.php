@extends('landing.layout.master2')
...
<main class="site-main">
                            ...
                            <div class="col-lg-6">
                                <div class="banner-content white-text">
                                    <h1 class="h1-title">
                                        ...
                                        <span>
                                                Industry
                                                <img src="{{asset('vendor/landing2')}}/assets/images/title-line.svg" width="342" height="13" alt="Title line">
                                            </span>
                                    </h1>
                            ...
                            <div class="col-lg-6">
                                <div class="banner-image-path-main">
                                    <div class="banner-image-path-sub">
                                        <div class="banner-image back-img" style="background-image: url('{{asset('vendor/landing2')}}/assets/images/banner-image.jpg');">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-us-content wow fadeInRight" data-wow-duration=".8s" data-wow-delay=".2s">
                        ...
                        <a href="{{asset('vendor/landing2')}}/about-us.html" class="sec-btn" title="Discover More">Discover More</a>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="company-timeline wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".2s">
                        ...
                        <div class="company-experiance">
                            <img src="{{asset('vendor/landing2')}}/assets/images/plus-icon.svg" width="20" height="20" alt="Plus Icon">
            ...
            <div class="services-slider swiper wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".2s">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="services-box">
                            <div class="services-image">
                                <div class="back-img" style="background-image: url('{{asset('vendor/landing2')}}/assets/images/all-maintainance.jpg');"></div>
                            </div>
                            ...
                            <div class="services-box-content">
                                <h4 class="h4-title">
                                    <a href="{{asset('vendor/landing2')}}/service-details.html" title="All Maintenance">All Maintenance</a>
                                </h4>
                                <p>Vivamus vari fermentum vestibulum consectetur morbi at odio.</p>
                                <a href="{{asset('vendor/landing2')}}/service-details.html" class="sec-btn icon-lg" title="Go to All Maintenance"></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide odd">
                        <div class="services-box">
                            <div class="services-image">
                                <div class="back-img" style="background-image: url('{{asset('vendor/landing2')}}/assets/images/general-contract.jpg');"></div>
                            </div>
                            <div class="services-box-icon">
                            ...
                            <div class="services-box-content">
                                <h4 class="h4-title">
                                    <a href="{{asset('vendor/landing2')}}/service-details.html" title="General Contract">General Contract</a>
                                </h4>
                                <p>Vivamus vari fermentum vestibulum consectetur morbi at odio.</p>
                                <a href="{{asset('vendor/landing2')}}/service-details.html" class="sec-btn icon-lg" title="Go to General Contract"></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="services-box">
                            <div class="services-image">
                                <div class="back-img" style="background-image: url('{{asset('vendor/landing2')}}/assets/images/automobiles.jpg');"></div>
                            </div>
                            <div class="services-box-icon">
                            ...
                            <div class="services-box-content">
                                ...
                                <p>Vivamus vari fermentum vestibulum consectetur morbi at odio.</p>
                                <a href="{{asset('vendor/landing2')}}/service-details.html" class="sec-btn icon-lg" title="Go to Automobiles"></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide odd">
                        <div class="services-box">
                            <div class="services-image">
                                <div class="back-img" style="background-image: url('{{asset('vendor/landing2')}}/assets/images/mechanical-parts.jpg');"></div>
                            </div>
                            <div class="services-box-icon">
                            ...
                            <div class="services-box-content">
                                <h4 class="h4-title">
                                    <a href="{{asset('vendor/landing2')}}/service-details.html" title="Mechanical Parts">Mechanical Parts</a>
                                </h4>
                                <p>Vivamus vari fermentum vestibulum consectetur morbi at odio.</p>
                                <a href="{{asset('vendor/landing2')}}/service-details.html" class="sec-btn icon-lg" title="Go to Mechanical Parts"></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="services-box">
                            <div class="services-image">
                                <div class="back-img" style="background-image: url('{{asset('vendor/landing2')}}/assets/images/petroleum-gas.jpg');"></div>
                            </div>
                            <div class="services-box-icon">
                            ...
                            <div class="services-box-content">
                                <h4 class="h4-title">
                                    <a href="{{asset('vendor/landing2')}}/service-details.html" title="Petroleum & Gas">Petroleum & Gas</a>
                                </h4>
                                <p>Vivamus vari fermentum vestibulum consectetur morbi at odio.</p>
                                <a href="{{asset('vendor/landing2')}}/service-details.html" class="sec-btn icon-lg" title="Go to Petroleum & Gas"></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide odd">
                        <div class="services-box">
                            <div class="services-image">
                                <div class="back-img" style="background-image: url('{{asset('vendor/landing2')}}/assets/images/electric-engineer.jpg');"></div>
                            </div>
                            <div class="services-box-icon">
                            ...
                            <div class="services-box-content">
                                <h4 class="h4-title">
                                    <a href="{{asset('vendor/landing2')}}/service-details.html" title="Electric Engineer">Electric Engineer</a>
                                </h4>
                                <p>Vivamus vari fermentum vestibulum consectetur morbi at odio.</p>
                                <a href="{{asset('vendor/landing2')}}/service-details.html" class="sec-btn icon-lg" title="Go to Electric Engineer"></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="services-box">
                            <div class="services-image">
                                <div class="back-img" style="background-image: url('{{asset('vendor/landing2')}}/assets/images/smart-technology.jpg');"></div>
                            </div>
                            <div class="services-box-icon">
                            ...
                            <div class="services-box-content">
                                <h4 class="h4-title">
                                    <a href="{{asset('vendor/landing2')}}/service-details.html" title="Smart Technology">Smart Technology</a>
                                </h4>
                                <p>Vivamus vari fermentum vestibulum consectetur morbi at odio.</p>
                                <a href="{{asset('vendor/landing2')}}/service-details.html" class="sec-btn icon-lg" title="Go to Smart Technology"></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide odd">
                        <div class="services-box">
                            <div class="services-image">
                                <div class="back-img" style="background-image: url('{{asset('vendor/landing2')}}/assets/images/support-24x7.jpg');"></div>
                            </div>
                            <div class="services-box-icon">
                            ...
                            <div class="services-box-content">
                                <h4 class="h4-title">
                                    <a href="{{asset('vendor/landing2')}}/service-details.html" title="24x7 Support">24x7 Support</a>
                                </h4>
                                <p>Vivamus vari fermentum vestibulum consectetur morbi at odio.</p>
                                <a href="{{asset('vendor/landing2')}}/service-details.html" class="sec-btn icon-lg" title="Go to 24x7 Support"></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="join-us-content dark-bg">
                        ...
                        <a href="{{asset('vendor/landing2')}}/contact-us.html" class="sec-btn" title="Get a Quote">Get a Quote</a>
                        <div class="banner-shape">
                            <span class="stripe"></span>
                            <span class="stripe stripe-secondary"></span>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 order-lg-2">
                    <div id="counter" class="skills-content wow fadeInRight" data-wow-duration=".8s" data-wow-delay=".2s">
                        <div class="sec-title">
                                <span class="sub-title">
                                    <img src="{{asset('vendor/landing2')}}/assets/images/setting-icon.svg" width="18" height="18" alt="Setting Icon">
                                    PROCESS & SKILLS
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="our-work-content-wp">
                        ...
                        <div class="more-work">
                            <a href="{{asset('vendor/landing2')}}/portfolio.html" class="sec-btn wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".2s" title="Discover More">Discover More</a>
                        </div>
                        <div class="our-work-slider-wp wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".2s">
                            <div class="swiper our-work-slider">
                                <div class="swiper-wrapper">
                                        ...
                                        <div class="our-work-box">
                                            ...
                                            <div class="our-work-content">
                                                <div class="our-work-name">
                                                    <h4 class="h4-title">
                                                        <a href="{{asset('vendor/landing2')}}/portfolio.html" title="Electronic Material">Electronic Material</a>
                                                    </h4>
                                                    <span class="work-category">Industry Work</span>
                                                </div>
                                                <a href="{{asset('vendor/landing2')}}/portfolio.html" class="read-more-services sec-btn icon-lg" title="Electronic Material"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="our-work-box">
                                            <div class="back-img" style="background-image: url('assets/images/work-2.jpg');"></div>
                                            <div class="our-work-content">
                                                <div class="our-work-name">
                                                    <h4 class="h4-title">
                                                ...
                                                <a href="portfolio.html" class="read-more-services sec-btn icon-lg" title="Electronic Material"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="our-work-box">
                                            <div class="back-img" style="background-image: url('assets/images/work-3.jpg');"></div>
                                            <div class="our-work-content">
                                                <div class="our-work-name">
                                                    <h4 class="h4-title">
                                                        <a href="portfolio.html" title="Electronic Material">Electronic Material</a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="our-work-box">
                                            <div class="back-img" style="background-image: url('assets/images/explore-work-1-min.jpg');">
                                            </div>
                                            <div class="our-work-content">
                                                <div class="our-work-name">
                                                    <h4 class="h4-title">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="our-work-box">
                                            <div class="back-img" style="background-image: url('assets/images/explore-work-2-min.jpg');">
                                            </div>
                                            <div class="our-work-content">
                                                <div class="our-work-name">
                                                    <h4 class="h4-title">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="our-work-box">
                                            <div class="back-img" style="background-image: url('assets/images/explore-work-3-min.jpg');">
                                            </div>
                                            <div class="our-work-content">
                                                <div class="our-work-name">
                                                    <h4 class="h4-title">
                ...
                <div class="col-lg-4">
                    <div class="pricing-box wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".2s">
                        <div class="pricing-icon">
                                <span>
                                    <img src="{{asset('vendor/landing2')}}/assets/images/basic-pricing.svg" width="40" height="40" alt="Basic pricing icon">
                                </span>
                        </div>
    ...
    <section class="testimonials">
        <img src="{{asset('vendor/landing2')}}/assets/images/globe.svg" class="bg-glob" width="687" height="744" alt="Globe Icon">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="sec-title">
                    ...
                    <div class="swiper testimonial-slider wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".2s">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-box">
                                    ...
                                    <div class="testimonial-author">
                                        <div class="author-img">
                                            <div class="back-img" style="background-image: url(assets/images/mark-john.jpg);"></div>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-box">
                                    ...
                                    <div class="testimonial-author">
                                        <div class="author-img">
                                            <div class="back-img" style="background-image: url(assets/images/patrick-palmer.jpg);">
                                            </div>
                                        </div>
                                        <div class="author-content">
                                            <h4 class="h4-title">Mark John</h4>
            ...
            <div class="row">
                <div class="col-lg-7 order-lg-1 order-2 align-self-center">
                    <div class="global-clients-list wow fadeInLeft" data-wow-duration=".8s" data-wow-delay=".2s">
                        ...
                        <img src="{{asset('vendor/landing2')}}/assets/images/polymath.svg" width="130" height="30" alt="Polymath Icon">
                        <img src="{{asset('vendor/landing2')}}/assets/images/featherdev.svg" width="130" height="25" alt="Featherdev Icon">
                        <img src="{{asset('vendor/landing2')}}/assets/images/boltshift.svg" width="130" height="34" alt="Boltshift Icon">
                        <img src="{{asset('vendor/landing2')}}/assets/images/lightbox.svg" width="130" height="33" alt="Lightbox Icon">
                        <img src="{{asset('vendor/landing2')}}/assets/images/shperule.svg" width="130" height="39" alt="Shperule Icon">
                        <img src="{{asset('vendor/landing2')}}/assets/images/globalbank.svg" width="130" height="30" alt="Global bank Icon">
            ...
            <div class="blog-box-wp">
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-box wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".2s">
                            <div class="blog-image">
                                <a href="blog-detail.html" class="back-img" style="background-image: url('assets/images/new-machine-image.jpg');" title="New machine will efficient big factory"></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-box wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".2s">
                            <div class="blog-image">
                                <a href="blog-detail.html" class="back-img" style="background-image: url('assets/images/how-to-build.jpg');" title="How to build for best new machinery industry"></a>
                                <p class="blog-published">7 June, 2024</p>
                            </div>
                            <div class="blog-box-content">
                                <h4 class="h4-title">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-box wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".2s">
                            <div class="blog-image">
                                <a href="blog-detail.html" class="back-img" style="background-image: url('assets/images/we-are-best.jpg');" title="We are best any industrial & business solution"></a>
                                <p class="blog-published">7 June, 2024</p>
                            </div>
                            <div class="blog-box-content">
                                <h4 class="h4-title">
