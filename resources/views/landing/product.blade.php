        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 float-right">
                <div class="shop-content">
                    ...
                    <div class="rinbuild-carousel shop-carousel owl-carousel owl-theme owl-nav-style-one" data-options='{"loop":true, "margin":30, "autoheight":true, "nav":true, "dots":false, "autoplay":true, "autoplayTimeout":6000, "smartSpeed":500, "responsive":{ "0":{"items": "1"}, "768":{"items": "2"}, "1000":{"items": "4" }}}'>
                        @foreach($products as $product)
                            <div class="single-product-item">
                                <div class="img-holder">
                                    <img src="{{ asset('vendor/landing')}}/assets/images/shop/shop-1.jpg" alt="Awesome Product Image">
                        ...
                        <div class="single-product-item">
                            <div class="img-holder">
                                <img src="{{ asset('vendor/landing')}}/assets/images/shop/shop-2.jpg" alt="Awesome Product Image">
                                <div class="overlay-content">
                                    <a href="#">Add To Cart<span class="flaticon-supermarket"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="single-product-item">
                            <div class="img-holder">
                                <img src="{{ asset('vendor/landing')}}/assets/images/shop/shop-3.jpg" alt="Awesome Product Image">
                                <div class="overlay-content">
                                    <a href="#">Add To Cart<span class="flaticon-supermarket"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="single-product-item">
                            <div class="img-holder">
                                <img src="{{ asset('vendor/landing')}}/assets/images/shop/shop-4.jpg" alt="Awesome Product Image">
                                <div class="overlay-content">
                                    <a href="#">Add To Cart<span class="flaticon-supermarket"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="single-product-item">
                            <div class="img-holder">
                                <img src="{{ asset('vendor/landing')}}/assets/images/shop/shop-5.jpg" alt="Awesome Product Image">
                                <div class="overlay-content">
                                    <a href="#">Add To Cart<span class="flaticon-supermarket"></span></a>
                                </div>
                            </div>
