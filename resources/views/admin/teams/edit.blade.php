                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="custom-file-upload">
                                        ...
                                        <div class="file-upload-preview mt-2">
                                            @if($team->photo)
                                            <img src="{{ $team->photo_url }}" class="img-thumbnail"
                                                style="max-height: 150px;">
                                            <span class="file-name">{{ basename($team->photo) }}</span>
                                            @else
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                name="order" value="{{ old('order', $team->order) }}" min="0">
                                            @error('order')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-select @error('status') is-invalid @enderror"
                                                ...
                                                <option value="active" {{ old('status', $team->status) == 'active' ?
                                                    'selected' : '' }}>Active</option>
                                                <option value="inactive" {{ old('status', $team->status) == 'inactive' ?
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                        ...
                                        rows="5">{{ old('description', $team->description) }}</textarea>
                                    @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
