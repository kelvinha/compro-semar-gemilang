                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <div class="btn-group" role="group">
                            <a href="{{ route('admin.blogs.edit', ['blog' => $blog, 'lang' => 'en']) }}"
                                class="btn {{ $language == 'en' ? 'btn-primary' : 'btn-outline-primary' }}">English</a>
                            <a href="{{ route('admin.blogs.edit', ['blog' => $blog, 'lang' => 'id']) }}"
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title_id') is-invalid @enderror"
                                        id="title_id" name="title_id" value="{{ old('title_id', $blog->title_id) }}"
                                        required>
                                    @error('title_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('excerpt') is-invalid @enderror" id="excerpt"
                                        name="excerpt" rows="3">{{ old('excerpt', $blog->excerpt) }}</textarea>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('excerpt_id') is-invalid @enderror"
                                        id="excerpt_id" name="excerpt_id"
                                        rows="3">{{ old('excerpt_id', $blog->excerpt_id) }}</textarea>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control ckeditor @error('content_id') is-invalid @enderror"
                                        ...
                                        rows="10">{{ old('content_id', $blog->content_id) }}</textarea>
                                    @error('content_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control @error('status') is-invalid @enderror"
                                                ...
                                                <option value="{{ $key }}" {{ old('status', $blog->status) == $key ?
                                                    'selected' : '' }}>
                                                    {{ $value }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" id="featured"
                                                name="featured" value="1" {{ old('featured', $blog->featured) ?
                                            'checked' : '' }}>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <select class="form-control @error('category_id') is-invalid @enderror"
                                                ...
                                                <option value="{{ $id }}" {{ old('category_id', $blog->category_id) ==
                                                    $id ? 'selected' : '' }}>
                                                    {{ $name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <img src="{{ asset('storage/' . $blog->featured_image) }}"
                                                alt="{{ $blog->title }}" class="img-fluid img-thumbnail">
                                        </div>
                                        @endif
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('meta_title', $blog->seo->title ?? '') }}">
                                            @error('meta_title')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea
                                                ...
                                                rows="3">{{ old('meta_description', $blog->seo->description ?? '') }}</textarea>
