                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('industry') is-invalid @enderror"
                                        ...
                                        <option value="{{ $value }}" {{ old('industry', $client->industry) == $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                        id="description" name="description" rows="4">{{ old('description', $client->description) }}</textarea>
                                    @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description_id') is-invalid @enderror"
                                        id="description_id" name="description_id" rows="4">{{ old('description_id', $client->description_id) }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('contact_info') is-invalid @enderror"
                                        ...
                                        placeholder='{"email": "contact@client.com", "phone": "+1234567890"}'>{{ old('contact_info', $client->contact_info ? json_encode($client->contact_info, JSON_PRETTY_PRINT) : '') }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('services_provided') is-invalid @enderror"
                                        ...
                                        placeholder='["Web Development", "SEO", "Digital Marketing"]'>{{ old('services_provided', $client->services_provided ? json_encode($client->services_provided, JSON_PRETTY_PRINT) : '') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="featured" name="featured" 
                                                {{ old('featured', $client->featured) ? 'checked' : '' }}>
