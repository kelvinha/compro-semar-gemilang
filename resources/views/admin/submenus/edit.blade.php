    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.submenus.update', $submenu) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('menu_id') is-invalid @enderror" id="menu_id"
                                        ...
                                        <option value="{{ $id }}" {{ old('menu_id', $submenu->menu_id) == $id ?
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ old('name', $submenu->name) }}" required>
                                    @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('type') is-invalid @enderror" id="type"
                                        ...
                                        <option value="{{ $key }}" {{ old('type', $submenu->type) == $key ? 'selected' :
                                            '' }}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('type')
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('url') is-invalid @enderror" id="url"
                                        name="url" value="{{ old('url', $submenu->url) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('parent_id') is-invalid @enderror" id="parent_id"
                                        ...
                                        <option value="{{ $id }}" {{ old('parent_id', $submenu->parent_id) == $id ?
                                            'selected' : '' }}>{{ $name }}</option>
                                        @endforeach
                                    </select>
                                    @error('parent_id')
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('order') is-invalid @enderror"
                                        id="order" name="order" value="{{ old('order', $submenu->order) }}">
                                    @error('order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-switch mt-2">
                                        <input class="form-check-input" type="checkbox" id="active" name="active"
                                            value="1" {{ old('active', $submenu->active) ? 'checked' : '' }}>
