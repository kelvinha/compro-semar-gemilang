        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h5 class="m-b-10">Create Permission</h5>
                </div>
                <ul class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <small class="form-text text-muted">Permission name (e.g., create-users, edit-posts)</small>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <small class="form-text text-muted">Human-readable name (e.g., Create Users, Edit Posts)</small>
                                @error('display_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <select class="form-control @error('group') is-invalid @enderror" id="group-select" name="group">
                                        <option value="">Select or enter a group</option>
                                        @foreach($groups as $group)
                                            <option value="{{ $group }}" {{ old('group') == $group ? 'selected' : '' }}>{{ ucfirst($group) }}</option>
                                        @endforeach
                                    </select>
                                    <input type="text" class="form-control d-none" id="group-input" placeholder="Enter new group name">
                                    <button class="btn btn-outline-secondary" type="button" id="toggle-group-input">New</button>
                                </div>
                                <small class="form-text text-muted">Group for organizing permissions (e.g., users, posts)</small>
                                @error('group')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
